#!/usr/bin/env bash
#
# Consilium deployment kit: upgrade. See deploy/kit.py for what it does, and
# docs/RUNBOOK.md for when to run it.
#
#   ./upgrade.sh --config /etc/consilium/consilium.conf --bundle consilium-bundle.tar.gz
#
