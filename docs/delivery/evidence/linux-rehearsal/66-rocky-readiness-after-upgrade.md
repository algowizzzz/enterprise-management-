...
- Generated: 2026-09-18T07:42:43+00:00
...
```
{"ok": true, "workflow": "Readiness ad5650", "created_in_state": "Readiness ad5650 Pending", "open_workflow_actions_before": 1, "state_after_approve": "Readiness ad5650 Approved", "workflow_actions": [{"name": "cms4t37h5e", "status": "Completed", "workflow_state": "Readiness ad5650 Pending", "completed_by": "Administrator"}], "version_rows": 1, "version_records_state_change": true, "cleanup": "removed everything it created"}
```

### PDF: a governing document renders to a valid PDF

```
{"ok": true, "engine": "0.12.6.1", "document": "GDOC-00015", "seconds": 2.59, "bytes": 27984, "starts_with_pdf_header": true, "ends_with_eof": true, "pages": 3}
```
...
```
2026-09-18T07:38:06+00:00: 0 network lines in pip-20260918-073728.log; internet from the host unreachable
2026-09-18T07:41:11+00:00: 0 network lines in pip-20260918-074031.log; internet from the host unreachable
```
