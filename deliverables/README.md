...
|---|---|---|
| `Consilium-Leadership-Briefing.pptx` | Leadership briefing: the product, what was built, evidence, roadmap (49 slides) | `.venv/bin/python scripts/deck/build_deck.py --out deliverables/Consilium-Leadership-Briefing.pptx`, from `scripts/deck/facts.json` (numbers and statuses) and `scripts/deck/slides.py`, with screenshots from `docs/guides/images/`. See [`docs/OPERATIONS.md`](../docs/OPERATIONS.md) §F |
